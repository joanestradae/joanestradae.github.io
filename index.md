<html>
    ...
    <body>
        ...
        <li>use rem and rm units for one of your elemnts</li>
        <li>apply padding, margin and border styles to an element, learn their differences </li>
        <li>A button.</li>
        ...
        <br>
        <p style="font-size:22px;">The idea here is to learn a bit more about how css and html work. You can make it as complex as you'd like. You can copy paste a lot of these stuff, but at least play around with the code just to get a grasp on what every line does, it can be fun. I can't stress enough how useful W3 schools can be to learn how html and css work.  </p>
    </body>
</html>
