<html>
    ...
    <body>
        <div><IMG SRC="imagenes/jebusDance.gif" class="gif"> <IMG SRC="imagenes/reloj_60px1.gif"class="gif"><IMG SRC="imagenes/gusano_60px1.gif">
            <IMG SRC="imagenes/tostadora_100px1.gif"class="gif"><IMG SRC="imagenes/campana_80px1.gif"class="gif"></div>
